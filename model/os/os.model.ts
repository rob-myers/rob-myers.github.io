...
export enum OsAct {
  ...
  /**
   * Store data in the UI panel for this session.
   */
  OS_STORE_DATA_IN_PANEL= 'OS_STORE_DATA_IN_PANEL',
  /**
  ...
  OS_SET_SESSION_PANEL_METAS_THUNK= 'OS_SET_SESSION_PANEL_METAS_THUNK',
...
/**
 * Keys which may exist in {WindowPanel}s wrapping sessions.
 */
export enum OsPanelMetaKey {
