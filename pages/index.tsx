...
Also, although it is true that browsing a website begins by downloading HTML, the latter is often generated by JS running on a server. Then browsing a website amounts to _running JavaScript_, initially remotely and subsequently on our own machine. The resulting stateful application depends on our input, various kinds of local storage and also API responses i.e. the backend infrastructure.
...
> The developer browses the site, but instead runs JS autogenerated from source code on their own machine. They run additional JS in the browser, in order to _sync the website with the autogenerated JS_. This saves time and improves the development experience.
