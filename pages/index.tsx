...
- via [JSX](https://en.wikipedia.org/wiki/JSX_(JavaScript)) (syntactic sugar) and [tagged templates](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#tagged_templates) (added in ES6) combined with runtime DOM diffing.
