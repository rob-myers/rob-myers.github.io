...
To get a better handle, consider some code.
        `}/>
...
- Executing a React application amounts to invoking _ReactDOM.render_.
  The provided arguments are _\\<App/\\>_ and some pre-existing DOM node.
  Initially the [render function](https://github.com/preactjs/preact/blob/master/src/render.js) converts the virtual DOM tree into an actual DOM tree.
...
As mentioned above, this website is built using Preact, a popular alternative to React.
I chose Preact because it has the same API as React, but with a much smaller codebase, making it easier to understand.
It also provides hooks into its underlying operations, which will help us to improve performance.

__TODO__ say someting about styles too
