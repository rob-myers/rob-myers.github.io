...
It is now the only programming language supported by all web browsers. JavaScript (JS) has two siblings i.e. HTML (hierarchy of elements on a webpage) and CSS (their look and feel). It can subsume them both,
...
Here's the simplest example: a JSX source file is changed, a new JS file is somehow autogenerated, the browser-based additional JS is somehow informed, finally it decides to trigger a full page reload. But refreshing a webpage is not unlike rebooting an application. It takes time and you're likely to lose emphemeral state e.g.
