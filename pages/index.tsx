...
To see it in action, try clicking the other tabs above, or [view the CodeSandbox](https://codesandbox.io/s/rogue-markup-panzoom-yq060?file=/src/panzoom/PanZoom.jsx "@external"). The guts of the PanZoom component have been collapsed (see line 10).
Semantically:
...
React developers use an extension of JS called [JSX](https://en.wikipedia.org/wiki/JSX_(JavaScript)),
...
This website uses Preact, a popular alternative to React.
