...
# Objectives <BlogCounter date="1st September 2020" number="1" />
...
- will explain how video games have attempted to answer the [central question](#central-question).
- will develop rich, repeatable behavioural experiences.

In particular, we'll develop an engine and use it to explain well-travelled techniques.
...
<Citation hash="worm" label="Worm">
  See <ExtLink href="https://en.wikipedia.org/wiki/OpenWorm">OpenWorm</ ExtLink> and <ExtLink href="http://www.wisdom.weizmann.ac.il/~harel/papers/GrandChallenge.doc">David Harel's publication.</ExtLink>
</Citation>
