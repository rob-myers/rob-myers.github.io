...
We, the animals of this world, are miraculous mechanisms.
...
In particular, each cleverly constructed machine with behaviour $L \subseteq \Sigma^*$ yields a small biclique edge-covering $\mathscr{C}$ of a natural bipartite graph $\mathcal{SD}_L\subseteq\mathsf{LD}(L)\times\mathsf{syn}(L)$. Crucially, the $\mathscr{C}$ arising in this way are precisely those satisfying:
$$
