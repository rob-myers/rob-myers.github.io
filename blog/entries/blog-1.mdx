...
The emergence of our collective behaviour from mechanical underpinnings remains a deep mystery.
To understand how the complex arises from  


One objective of this website is to indirectly attack this problem.
Rather than attempting to model the particulars, we present a new richer theory of finite-state-machines. This is achieved by building a bridge between _algebraic automata theory_ and _nondeterministic state complexity_.

<br/>
<br/>


The site presents a new theory of finite state machines.

But in what sense do we provide a _theory_? In what sense is it _new_?

 (see e.g. <Ext href="https://arxiv.org/abs/2101.03039">a</Ext>, <Ext href="https://link.springer.com/chapter/10.1007%2F978-3-662-44124-4_11">b</Ext> and <Ext href="https://www.sciencedirect.com/science/article/pii/S1571066114000693?via%3Dihub">c</Ext>).

<!--
  imaginative outlet provided by e.g.
  - illustrating syntactic monoid
  - illustrating subset construction
  - providing software to investigate these concepts

  emphasize connection between algebraic automata theory to nondeterministic complexity.
-->
